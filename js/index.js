...
// VARIABLES
var Nav = $("header nav"),
  menuButton = $("header nav .navsection .nav-menu-button"),
  firstLine = $("header nav .navsection .nav-menu-button span:first-of-type"),
  lastLine = $("header nav .navsection .nav-menu-button span:last-of-type"),
  navMenuContainer = $("header nav .navsection .nav-menu-container"),
  menuLinks = $("header nav .navsection .nav-menu li a"),
...
$(function () {
  ...
  $document.on("click", function (e) {
    if (
      $(e.target).closest(
        $(
          "header nav .navsection .nav-menu-button:not(.button-when-menu-is-open)"
        )
      ).length
    ) {
      ...
      $(e.target).closest($("header nav .navsection .button-when-menu-is-open"))
        .length
    ) {
      ...
      $("header nav .navsection .button-when-menu-is-open").click();
    }
  });
  ...
  if ($(".about").length) {
    ...
    $(".about .section-content .section-text .video-play-button a").on(
      "click",
      function () {
...
$window.on("load", function () {
  ...
  $(".portfolio .portfolio-content ul.work-cat li:first-of-type").on(
    "click",
    function () {
  ...
  $(".portfolio .portfolio-content ul.work-cat li:not(:first-of-type)").on(
    "click",
    function () {
